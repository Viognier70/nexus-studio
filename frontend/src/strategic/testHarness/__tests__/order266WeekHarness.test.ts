// ORDER 266 (Nexus v1 etapp 4) — veckoharnessen efter etappen.
//
...
// skrivs till reports/order266/week-harness.json, och testet hävdar ur
...
const OUT = resolve(dirname(fileURLToPath(import.meta.url)), '../../../../reports/order266');

describe('ORDER 266 — veckoharnessen', () => {
