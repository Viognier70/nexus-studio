...
| 039 | Building Overlap Diagnostic | Pending | **Own document** | `ORDER_039_BUILDING_OVERLAP_DIAGNOSTIC.md`. Parent: `PHASE_IV_PRODUCTION_PLAN.md` (visual acceptance criterion); `ADR_001_DIGITAL_TWIN_PHASE.md`. Diagnostic-only: reports building-versus-building geometric overlaps, church-adjacent buildings and height-assignment mechanism; changes nothing under `frontend/src/strategic/data/`. |
