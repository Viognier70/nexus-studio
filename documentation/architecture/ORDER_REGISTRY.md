...
| 038 | Rv 244 Curvature Layer | Pending | **Own document** | `ORDER_038_RV244_CURVATURE_LAYER.md`. Parent: `ADR_001_DIGITAL_TWIN_PHASE.md` §2.2, §2.3; `SUPERSEDING_DIRECTIVE_002.md` §1 (decision B). |
